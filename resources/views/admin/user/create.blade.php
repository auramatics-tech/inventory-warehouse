                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5">
                                    <div class="row">
                                        <div class="form-group col-md-6 ">
                                            ...
                                            <input value="{{ isset($user->name) ? $user->name: '' }}" type="text" class="form-control" name="name" id="name" placeholder="Name" required>
                                        ...
                                        <div class="form-group col-md-6 ">
                                            ...
                                            <input value="{{ isset($user->name) ? $user->email: '' }}" type="text" class="form-control" name="email" id="email" placeholder="Email">
                                            <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="form-group col-md-6 ">
                                            ...
                                            <input value="{{ isset($user->phone_no) ? $user->phone_no: '' }}" type="number" class="form-control" name="phone_no" id="phone_no" placeholder="Phone no.">
                                            <span class="invalid-feedback" role="alert">
