        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <form class="d-flex align-items-center position-relative my-1" method="get">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" class="form-control form-control-solid w-250px ps-14" placeholder="Search Shelve" value="{{isset(request()->q) ? request()->q : ''}}" name="q">
                    </form>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
            ...
            <div class="card-body pt-0">
                ...
                <div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_table_users">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1" aria-label="User: activate to sort column ascending" style="width: 224.953px;">Branch name</th>
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                ...
                                <tr class="odd">
                                    ...
                                    <!--end::User=-->
                                    <!--begin::Role=-->
                                    <td>{{isset($shelve->get_branch_name->name) ? $shelve->get_branch_name->name :'' }}</td>
                                    <td>{{($shelve->active == 1) ? 'Active' : 'Not Active'}}</td>
                                    <!--end::Role=-->
                                    <!--begin::Last login=-->
                                    <td data-order="2023-01-08T12:00:52+05:30">
                                        <div class="badge badge-light fw-bolder">{{ date('F d, Y', strtotime($shelve->created_at))}}</div>
                                    </td>
                                    <!--begin::Action=-->
                                    <td class="text-end">
                    ...
                    {{ $shelves->withQueryString()->onEachSide(0)->links("pagination::bootstrap-4") }} 
                    </div>
                </div>
                <!--end::Table-->
            </div>
