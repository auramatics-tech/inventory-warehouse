                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                        <div class="col-md-12 p-9">
                            ...
                            <form id="itemRows_0" method="post">
                                    ...
                                    <input type="hidden" value="{{ csrf_token() }}" name="_token">
                                        ...
                                        <div class="row mt-3" id="to_branch_data">
                                           {{-- <div class="form-group col-md-4 mb-3">
                                                ...
                                                <select name="shelve" id="shelves_dropdown_0" class="form-control" data-id="0">
                                                    <option value="">Shelves Branch</option>
                                                </select>
                                            </div> --}}
                                            <div class="form-group col-md-4 mb-3">
                                                <label for="">Quantity</label>
                                                <input type="number" name="quantity" class="form-control" id="quantity_0" placeholder="Qty" data-id="0">
                                            </div>
                                        ...
                                        <span id="success_msg_0" class="alert-success"></span>
                                    </form>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                        <button type="button" id="transfer_btn_0" data-type="transfer" class="btn transfer_btn btn-primary py-2 mt-4 status_change" data-id="0">Transfer All</button>
                           <a href="" class="btn btn-primary py-2 mt-4">Cancel</a>
                        </div>
                    <!--end::Form-->
                </div>
                <!--end::Card-->
...
//    
    ...
    function addRow() {
        count++;
        var html = ' <form id="itemRows_' + count + '" method="post">\n\
        <input type="hidden" value="{{ csrf_token() }}" name="_token">\n\
        ...
        <div class="row mt-3" id="to_branch_data">\n\
            ...
            <label for="">Qunatity</label>\n\
                <input type="number" name="quantity" class="form-control" id="quantity_' + count + '" placeholder="Qty" data-id="' + count + '">\n\
            </div>\n\
            <input type="button" class="text-white bg-danger cancel_row " value="X" onclick="removeRow(' + count + ')">\n\
        </div>\n\
        <span id="success_msg_' + count + '" class="alert-success"></span>\n\
    </form>';
...
<script>
    ...
    //     e.preventDefault();
    //     $('#itemRows_'+input_id).validate({ // initialize the plugin
    //         rules: {
    //             product_name: {
    //                 required: true,
    //             },
    ...
    //             quantity: {
    //                 required: true,
    //                 min:$('#quantity_'+input_id).attr('min')
    //             }
    //         }
    //     });
    //     if (!$('#itemRows_'+input_id).valid()) {
    //         return false;
    //     }
    //     var $this = $(this);
    //     Swal.fire({
    //         title: 'Are you sure want to transfer this product?',
    //         icon: 'warning',
