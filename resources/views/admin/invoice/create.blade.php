                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="row mt-5">
                                    <div class="form-group col-md-3 mb-3">
                                        ...
                                        <select name="product_id[]" id="product_code" class="form-control" required>
