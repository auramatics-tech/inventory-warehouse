        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                ...
                                <tr class="odd">
                                    ...
                                    <td data-order="2023-01-08T12:00:52+05:30">
                                        <div class="badge badge-light fw-bolder">{{ date('F d, Y', strtotime($product->created_at))}}</div>
                                    </td>
                                    <!--begin::Action=-->
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{route('admin.edit_product',$product->id)}}" class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                    ...
                    {{ $products->withQueryString()->onEachSide(0)->links("pagination::bootstrap-4") }} 
                    </div>
                </div>
                <!--end::Table-->
            </div>
