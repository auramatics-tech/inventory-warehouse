        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <form class="d-flex align-items-center position-relative my-1" method="get">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" class="form-control form-control-solid w-250px ps-14" placeholder="Search Branch" value="{{isset(request()->q) ? request()->q : ''}}" name="q">
                    </form>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        <!--begin::Add user-->
                        <a href="{{Route('admin.create_branch')}}" type="button" class="btn btn-primary">
            ...
            <div class="card-body pt-0">
                ...
                <div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_table_users">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <!-- <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1" aria-label="Role: activate to sort column ascending" style="width: 125px;">Active</th> -->
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                ...
                                <tr class="odd">
                                    ...
                                    <!--end::User=-->
                                    <!--begin::Role=-->
                                    <!-- <td>{{($branch->active == 1) ? 'Active' : 'Not Active'}}</td> -->
                                    <!--end::Role=-->
                                    <!--begin::Last login=-->
                                    <td data-order="2023-01-08T12:00:52+05:30">
                                        <div class="badge badge-light fw-bolder">{{ date('F d, Y', strtotime($branch->created_at))}}</div>
                                    </td>
                                    <!--begin::Action=-->
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{route('admin.edit_branch',$branch->id)}}" class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="javascript:" rel="{{ $branch->id }}" rel1="delete-branch" class="deleteRecord menu-link px-3">Delete</a>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                        <!--end::Menu-->
                    ...
                    {{ $branches->withQueryString()->onEachSide(0)->links("pagination::bootstrap-4") }} 
                    </div>
                </div>
                <!--end::Table-->
            </div>
